...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      './app/js/app.js',  
      './app/js/appRoutes.js',
      './app/js/controllers/AuthenticationCtrl.js',
      './app/js/services/AuthenticationService.js',
      './app/js/controllers/PatientProviderCtrl.js',
      './app/js/services/PatientProviderService.js',
      './app/js/services/AuthenticationService.spec.js',
      './app/js/services/PatientProviderService.spec.js'
    ],
